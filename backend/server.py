...
SEARXNG_URL = os.environ.get('SEARXNG_URL', 'https://duckduckgo.com')  # es. https://zalvion-search.onrender.com
...
async def searxng_web_search(query: str, num_results: int = 5) -> str:
    ...
    if not SEARXNG_URL or not query.strip():
        return ""
    params = {"q": query.strip()[:300], "format": "json", "no_html": "1", "skip_disambig": "1"}
